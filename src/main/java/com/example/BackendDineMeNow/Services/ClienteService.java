...
public interface ClienteService {
    ...
    void cambiarPasswordPorDocumento(String documento, String passwordActual, String passwordNueva);
    void cambiarPasswordPorId(String id, String passwordActual, String passwordNueva);
}